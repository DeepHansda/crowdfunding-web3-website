...
function CreateCampaign() {
  const { publishCampaign, loading } = useStateContext();
      ...
      <div className="w-screen h-screen flex items-center justify-center ">
        <div className="w-[400px] bg-[#343a40] text-center rounded-xl py-5 shadow-md hover:shadow-[0_0px_16px_4px_#db00b6] transition-all duration-300">
          <div className="w-full text-center">
            <h2 className="bg-[#495057] w-fit mx-auto px-5 py-2 font-bold text-xl uppercase text-[#db00b6] rounded-lg shadow-lg">
              Create Campaign
            </h2>
          </div>
